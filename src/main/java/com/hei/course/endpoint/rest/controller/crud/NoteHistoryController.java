...
public class NoteHistoryController {
  ...
  public ResponseEntity<NoteHistory> create(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(noteHistoryService.create(noteHistory, noteId, currentUser));
  }

  @GetMapping
  public ResponseEntity<List<NoteHistory>> findAll(Authentication authentication) {

    Users currentUser = getCurrentUser(authentication);

    return ResponseEntity.ok(noteHistoryService.findAll(currentUser));
  }
  ...
  public ResponseEntity<NoteHistory> findById(
    ...
    return ResponseEntity.ok(noteHistoryService.findById(id, currentUser));
  }
  ...
  public ResponseEntity<NoteHistory> update(
    ...
    return ResponseEntity.ok(noteHistoryService.update(id, noteHistory, noteId, currentUser));
  }
