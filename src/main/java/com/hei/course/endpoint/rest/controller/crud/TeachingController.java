...
public class TeachingController {
  ...
  public ResponseEntity<Teaching> create(
      @RequestParam UUID courseId, @RequestParam UUID teacherId) {
  ...
  public ResponseEntity<Teaching> update(
      @PathVariable UUID id, @RequestParam UUID courseId, @RequestParam UUID teacherId) {

    return ResponseEntity.ok(teachingService.update(id, courseId, teacherId));
  }
  ...
  public ResponseEntity<List<Teaching>> findByTeacher(@PathVariable UUID teacherId) {

    return ResponseEntity.ok(teachingService.findByTeacher(teacherId));
  }
}
